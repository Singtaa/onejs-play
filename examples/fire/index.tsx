...
const body: fx.NoiseOptions = { type: "turbulence", seed: 1, octaves: 3, scale: [0.8, 0.5], scroll: [0, -0.35] }
const detail: fx.NoiseOptions = { type: "turbulence", seed: 2, octaves: 3, scale: [1.6, 1], scroll: [0, -0.62] }
...
function Fire() {
    const flame = fx.useAnimatedTexture(canvas, () => {
        ...
        return heat.threshold(0.005, 0.12).ramp(embers)
    })
